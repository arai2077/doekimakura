...
import { TITLE, CARD_CONTENTS_3D } from "./constants";
...
export const Portfolio3d: React.FC = () => {
  return (
    <>
      ...
      <div className="pl-8 pr-8 pb-8 grid grid-cols-1 md:grid-cols-3 gap-6 xl:gap-8">
        {CARD_CONTENTS_3D.map((item, index) => (
          <section className="flex" key={index}>
            <Card className="group gap-2 w-full max-w-4xl pt-2 pb-3 transition ease-in-out hover:-translate-y-3 hover:-translate-x-0 hover:shadow-[14px_16px_0px_var(--color-magenta)]/100">
